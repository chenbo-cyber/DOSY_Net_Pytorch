...
def options():
    ...
    parser.add_argument("--module_type", default='DOSY', type=str, help='type of the dosy module')
...
if __name__ == "__main__":
    args = options()
    args.input_file = 'data/TD/TD_net_input.mat'
    args.output_path = 'Net_Results/TD/'
    args.diff_range = []
